...
public class Assignment2 {
	...
	void automateSignUp() throws InterruptedException {
		WebDriver driver;
		String name = "purushottam07@test.com";
		...
		driver.findElement(By.xpath("//input[@id='customer_firstname']")).sendKeys("Purshottam");
		...
		driver.findElement(By.xpath("//input[@id='company']")).sendKeys("BOM");
		System.out.println("STEP-Enter Address");
		driver.findElement(By.xpath("//input[@id='address1']")).sendKeys("sada bahar society");
