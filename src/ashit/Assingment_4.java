...
public class Assingment_4 {
	void verifyYahooSignUpForm() throws InterruptedException{
		...
		driver.findElement(By.xpath("//input[@id ='usernamereg-firstName']")).sendKeys("Ashit");

		System.out.println("STEP :Enter LastName");
		driver.findElement(By.xpath("//input[@id ='usernamereg-lastName']")).sendKeys("Samdur");
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[@id ='usernamereg-yid']")).sendKeys("asamdur@yahoo.com");
		...
		driver.findElement(By.xpath("//input[@id ='usernamereg-day']")).sendKeys("07");
