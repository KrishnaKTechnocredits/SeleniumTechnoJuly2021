...
public class Assignment_2 
{
	...
	void automationPractice() throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//input[@name='customer_firstname']")).sendKeys("Manaswi");
		
		System.out.println("STEP : Enter lastname");
		driver.findElement(By.xpath("//input[@name='customer_lastname']")).sendKeys("Humbe");
		...
		driver.findElement(By.xpath("//input[@name='company']")).sendKeys("XYZ");
		
		System.out.println("STEP : Enter address");
		driver.findElement(By.xpath("//input[@name='address1']")).sendKeys("RadhaKrushna Colony");
		
		System.out.println("STEP : Enter address line 2");
		driver.findElement(By.xpath("//input[@name='address2']")).sendKeys("Vsant Vihar");
		
		System.out.println("STEP : Enter city");
		driver.findElement(By.xpath("//input[@name='city']")).sendKeys("Solapur,Maharashra");
		...
		driver.findElement(By.xpath("//input[@name='postcode']")).sendKeys("413402");
		...
		driver.findElement(By.xpath("//input[@name='phone_mobile']")).sendKeys("8452013845");
	...
	public static void main(String[] args) throws InterruptedException {
		Assignment_2 assignment_2 = new Assignment_2("manaswo1010@gmail.com", "Manu@123");
