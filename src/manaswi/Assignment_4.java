...
public class Assignment_4 
{
	...
	void yahooSignIn() throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//input[@name = 'lastName']")).sendKeys("humbe");

		System.out.println("STEP : Enter Email");
		driver.findElement(By.xpath("//input[@name = 'yid']")).sendKeys("manaswi.humbe");

		System.out.println("STEP : Enter Password");
		driver.findElement(By.xpath("//input[@name = 'password']")).sendKeys("Man@123");

		System.out.println("STEP : Enter Mobile Number");
		driver.findElement(By.xpath("//input[@name='phone']")).sendKeys("8452013845");
		...
		birthMonth.selectByVisibleText("october");

		System.out.println("STEP : Enter Birth Date");
		driver.findElement(By.xpath("//input[@name='dd']")).sendKeys("10");
