...
public class Assignment_3 
{
	...
	void globalSQA()
	{
		...
		if (contact_text.equals("+91-8452013845"))
		...
		driver.findElement(By.xpath("//input[@name = 'comment_name']")).sendKeys("manaswi");

		System.out.println("STEP : Enter Email");
		driver.findElement(By.xpath("//input[@name='email']")).sendKeys("manaswi1010@gmail.com");
