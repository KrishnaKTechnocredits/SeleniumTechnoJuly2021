...
public class Assignment_3 {
	...
	void matchElementsThenFillForm() throws InterruptedException {
		...
		String number = driver.findElement(By.xpath(".//div[@id='contact_info-widget-3']/div[@class='icon_phone']")).getText();
		...
		driver.findElement(By.xpath("//textarea[@placeholder='Message']")).sendKeys("We are excited to hear about your new ideas, do not hesitate to share them with us.");
