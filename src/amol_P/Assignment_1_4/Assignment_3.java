...
public class Assignment_3 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@class='aqua_input' and @id='comment_name']")).sendKeys("Amol");

		driver.findElement(By.xpath("//input[@name='email']")).sendKeys("amol@gmail.com");

		driver.findElement(By.xpath("//input[@name='subject'][@id='subject']")).sendKeys("Subject selected");

		driver.findElement(By.xpath("//textarea[@name='comment']")).sendKeys("This is my 3rd assignment");
