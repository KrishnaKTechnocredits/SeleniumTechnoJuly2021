...
package elizabeth.Assignment_2;
...
public class Assignment2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@name='email_create']")).sendKeys("eliza@gmail.com");
		...
		driver.findElement(By.xpath("//input[@name='customer_firstname']")).sendKeys("Elizabeth");
		System.out.println("Step 8:Enter the lastname");
		driver.findElement(By.xpath("//input[@name='customer_lastname']")).sendKeys("Mary");
		...
		driver.findElement(By.xpath("//input[@name='company']")).sendKeys("Deloitte");
		System.out.println("Step 14:Enter the Address1");
		driver.findElement(By.xpath("//input[@name='address1']")).sendKeys("2nd cross,abc Layout");
		System.out.println("Step 15:Enter the Address2");
		driver.findElement(By.xpath("//input[@name='address2']")).sendKeys("Church Street");
		...
		driver.findElement(By.xpath("//input[@name='postcode']")).sendKeys("5770");;
		...
		driver.findElement(By.xpath("//input[@name='phone']")).sendKeys("5566778899");
		System.out.println("Step 21:Enter the Mobile Phone Number");
		driver.findElement(By.xpath("//input[@name='phone_mobile']")).sendKeys("5566778899");
